...
namespace TelegramBotIsSimple.Main.Commands.MultipleCommands
{
    ...
    internal class MultipleCommandsPatentEVM : MultipleCommand
    {
        ...
        /// </summary>
        ServiceCreatedProject CreatedProject = null;
        #endregion
        ...
        public void ReplaceProject(Project projetc)
        {
            ...
            List<string> allFiles = System.IO.Directory.GetFiles(System.IO.Path.GetDirectoryName(TelegramBotIsSimple.Main.Projects.Theme.FileNamesThemeEVM) + $"\\{projetc.NameTheme}\\").ToList();
